...
};var g=null;var n=function(u){if(!g){g=document.getElementsByTagName("head");g=g?g[0]:document.body;}g.appendChild(u);};var f=function(){return document.getElementsByTagName("script");
};var r=function(){var u=f();var v=null;d(u,function(){if(this.readyState==="interactive"){v=this;return v;}});return v;};var e=function(v,u,w){if(v.addEventListener){v.addEventListener(u,w);
...
var o=function(){var u=document.getElementsByTagName("script");var v="";d(u,function(){var w=this.getAttribute("data-main");if(w){v=w;return true;}});return v;
